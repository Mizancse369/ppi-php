        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form-signin" action="user_register.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" id="inputFirstName" class="form-control" name="first_name"
                           placeholder="First Name" required>

                    <label for="inputLastName" class="sr-only">Last Name</label>
                    <input type="text" id="inputLastName" class="form-control" name="last_name" placeholder="Last Name"
                           required>
